...
const Results = props => {
  const { className, page, size, order, orderBy, onRequestSort, onRequestPagination, isLoading, servers, numberOfElements, totalPages, fetchServers, deleteServers, ...rest } = props;
    ...
    >
      <Card>
        <TableToolbar
          ...
          numSelected={selectedServers.length}
          onDelete={() => deleteServers(selectedServers, setSelectedResults)}
        />
        <Divider />
                    ...
                    >
                      ...
                      <TableCell>
                        <div className={classes.nameCell}>
                          ...
                          >
                            {getInitials(server.url + ' ' + server.lastName)}
                          </Avatar>
                          <div>
                            {server.url}
                      ...
                      <TableCell>{server.login}</TableCell>
