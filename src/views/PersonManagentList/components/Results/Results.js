...
const Results = props => {
  const { className, page, size, order, orderBy, onRequestSort, onRequestPagination, isLoading, persons, numberOfElements, totalPages, fetchPersons, deletePersons, ...rest } = props;
    ...
    >
      <Card>
        <TableToolbar
          ...
          numSelected={selectedPersons.length}
          onDelete={() => deletePersons(selectedPersons, setSelectedResults)}
        />
        <Divider />
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TableSortLabel
                        ...
                        onClick={createSortHandler('personType')}
                        IconComponent={SortIcon}>
                        Tipo
                      </TableSortLabel>
                    </TableCell>
                ...
                <TableBody>
                  ...
                  {persons.map(person => (
                    ...
                    >
                      ...
                      <TableCell>{person.personType.displayName}</TableCell>
